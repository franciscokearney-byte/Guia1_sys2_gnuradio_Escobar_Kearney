...
class actividad_7(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "actividad_7")
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/fkearney/Descargas/guitar.wav', True)
...
def main(top_block_cls=actividad_7, options=None):
